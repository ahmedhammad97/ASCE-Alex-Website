      ...
      <b-card no-body>
        <b-tabs pills card>
          ...
          <b-tab title="Conference '16"><b-card-text>
            ...
            <b-img-lazy :src="require('../../../assets/events/c16.jpg')" :blank-src="require('../../../assets/logoPlaceholder.jpg')" offset="800" alt="Construction Conference '16 group photo" class="groupPhoto" />
          </b-card-text></b-tab>
